...
export default function QuotePage() {
  ...
  const fetchQuote = async () => {
    ...
    try {
      ...
      setError("Failed to load quote. Please try again or sign in.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      <h1 className="text-4xl font-bold mb-4 text-center">Your Quote</h1>
      ...
      {loading ? (
        ...
        <div className="text-center bg-white dark:bg-zinc-900 rounded-xl shadow-lg p-6 max-w-xl">
      ...
      <div className="mt-6 text-sm text-muted-foreground text-center">
        <p>Selected genres: {genres.length > 0 ? genres.join(", ") : "None"}</p>
      </div>
    </div>
  );
}
